...
public class PassTemplateRowMapper implements RowMapper<PassTemplate> {
    ...
    /**
     * 列族b和其中所有列，对应HBase的byte数组形式的字节数组
     */
    ...
    /**
     * 列族c和其中所有列，对应HBase的byte数组形式的字节数组
     */
    ...
    public PassTemplate mapRow(Result result, int i) throws Exception {
        ...
        passTemplate.setStart(DateUtils.parseDate(Bytes.toString(result.getValue(FAMILY_C, END)), patterns));
